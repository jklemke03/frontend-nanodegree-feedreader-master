    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
		 ...
		 //Loops through all URLS to ensure not empty and defined.
         ...
         */
		 ...
		 //Loops through all feeds to make sure not empty and defined.
	...
	describe('The Menu', function() {
         ...
         */
		 //Menu hidden by menu-hidden class css. Make sure that the body has that.
		...
		it('menu toggles',function() {
			 //When first clicked, expect menu to open.
			$('.menu-icon-link').click();
			expect($('body').hasClass('menu-hidden')).toEqual(false);
			
			//When clicked again, expect menu to hide
			$('.menu-icon-link').click();
	...
	describe('Initial Entries', function() {
		...
		//Run load feed since asynchronous function. 
